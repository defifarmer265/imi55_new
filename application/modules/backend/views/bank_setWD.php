          ...
          <div class="col-md-4 col-sm-12  form-group has-feedback">
            <div class="form-group row">
              ...
              <div class="col-md-7 col-sm-7 ">
                <input type="text" class="form-control text-right" id="wd_min_amount"  value="<?=number_format($wd_min)?>">
              </div>
          ...
          <div class="col-md-4 col-sm-12  form-group has-feedback">
            <div class="form-group row">
              ...
              <div class="col-md-7 col-sm-7 ">
                ...
                <input type="text" class="form-control text-right" id="wd_count_amount"  value="<?=number_format($wd_count)?>">
              </div>
              <div class="col-md-2 col-sm-2 ">
          ...
          <div class="col-md-4 col-sm-12  form-group has-feedback">
            <div class="form-group row">
              ...
              <div class="col-md-7 col-sm-7 ">
                ...
                <input type="text" class="form-control text-right" id="wd_max_amount"  value="<?=number_format($wd_max)?>">
              </div>
              <div class="col-md-2 col-sm-2 ">
