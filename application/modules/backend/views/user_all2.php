                  ...
                  <table  class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody id="dataTB">
                        ...
                        <tr>
                          ...
                          <td><?= $us->username?></td>
                          <td><?= $us->name?></td>
                          <td><?= $us->account;?> <span class="badge badge-secondary"><?= $us->bank_short;?></span></td>
                          <td><?= $us->username?></td>
                          <td>
                              <?php
                                if($us->create_time == ""){
                                  ...
                                  echo date('d/m/Y',$us->create_time);
                                }
                               ?>
                             </td>
                        </tr>
        ...
        success: function(d) {
          ...
          $.each(d.user, function(index, val) {
            dataTB += `<tr align="center">
                          ...
                          <td>` + val.name + `</td>
                          <td>` + val.account +
                          `<span class="badge badge-secondary"> ` +val.bank_short + `</span>`+`</td>
                          <td>` + val.username + `</td>
