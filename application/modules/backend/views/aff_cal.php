                    ...
                    <div class="col-sm-12">
                      <div class="card-box table-responsive">
                        <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%" style="font-size: 14px;">
                            ...
                            <?php $i=0;   foreach($aff['aff'] as $f){  ?>
                            <tr class="text-center">
                              <td><?=$i+1?></td>
                              <td><a onClick="sdClass('<?=$f['id']?>')" data-toggle="modal" data-target="#getClass"><?=$f['id']?></a></td>
                              <td><?=$f['user']?></td>
                              <td><?=$f['sum']?></td>
                              <td><?=$f['date_update'] == 0 ? '' : date('d/m/Y H:i:s', $f['date_update'])?></td>
                              <td><?=$f['from_date'] == 0 ? '' : date('d/m/Y H:i:s', $f['from_date'])?></td>
                              </tr>
                            <?php $i++; }?>
                            </tbody>
                        </table>
