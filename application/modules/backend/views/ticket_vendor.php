	...
	<div class="right_col" role="main">
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 ">
				<div class="x_panel">
					<div class="x_title">
						<h2 style="color:#000">ประวัติการเล่นรวม<small></small></h2>
						<div class="clearfix"></div>
					</div>
					<div class="col-md-12 col-sm-12 ">
						<div class="x_content">
							<div class="row ">
								...
								<div class="col-sm-2">
									<div class="control-group">Vendor
										<select class="form-control" id="vendor">
											<option selected="">กรุณาเลือกเกมส์</option>
											<?php foreach ($vendor as $vd) { ?>
												<option value="<?= $vd['vendor_id'] ?>">
													<?= $vd['VendorName'] ?>
												</option>
											<?php } ?>
										</select>
								...
								<div class="col-sm-2">
									<br>
									<button type="button" onClick="select_vendor()" class="btn btn-info">ค้นหา</button>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-12">
