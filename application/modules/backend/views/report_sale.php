          ...
          <div class="x_content">
            <div class="col-md-12 col-sm-12">
              <div class="row">
                ...
                <br>
                <br>
                <div class="col-sm-1" id="button-block" style="margin-top: 18px;">
                  ...
                  <div class="row">
                    <div class="col-sm-10">
                      <div class="card-box table-responsive">
                        <table class="table table-striped table-bordered dt-responsive nowrap text-center" width="50%" cellspacing="0" id="t_all">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h6 class="modal-title" id="exampleModalCenterTitle">รายละเอียดยอดสมัคร</h6>
      </div>
      <div class="modal-body" align="center">
        <h6>สมัครผ่านเซลล์(ไม่ผ่านเซลล์)</h6>
        <h6 id="detail"></h6>
      </div>
      <div class="modal-footer">
...
<script type="text/javascript">
  function fisrt_depo() {
    ...
    $('#button-block').html('');
    $.ajax({
        url: '<?= base_url() ?>backend/sale/first_depo',
        type: 'POST',
        dataType: 'json',
        data: {
          d1: d1,
      ...
      .done(function(res) {
        ...
        if (res.code == 1) {
          ...
          if (count > 0) {
            ...
            var tt_count_manual = manual - tt_count_user;
            var content_sum = '<tr style="background-color: #007bff"><th colspan="3" class="text-center">รวม</th><th style="cursor: pointer;"  onclick="see_detail()">' + tt_count_user + '(' + tt_count_manual + ')</th><th >' + tt_count_first + '</th><th >' + tt_moreee + '</th><th >' + tt_less + '</th><th >' + tt_more + '</th></tr>';
          }
          ...
          var content_modal = '<span>' + tt_count_user + '(' + tt_count_manual + ')</span>'
          $('#bodyhistory').html(content);
          $('#report_sum').html(content_sum);
          $('#button-block').html(content2);
          $('#detail').html(content_modal);
          $('#list').html(content3);
        } else {
  ...
  //                                     data: [sale[i]['count_user']['user']]
  //                                 },{
  //                                   label: 'จำนวนยอดแรก',
  //                                   backgroundColor: 'rgb(215, 189, 226)',
  //                                   data: [sale[i]['count_first']]
  //                                 },{
  //                                   label: 'ยอดแรกน้อยกว่า 300',
  //                                   backgroundColor: 'rgb(218, 247, 166)',
  //                                   data: [sale[i]['less']]
  //                                 },{
  //                                   label: 'ยอดแรกมากกว่า 300',
  //                                   backgroundColor: 'rgb(127, 179, 213)',
  //                                   data: [sale[i]['more']]
  //                                 }],
</script>