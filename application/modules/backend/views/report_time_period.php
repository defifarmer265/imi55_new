...
<div class="right_col" role="main">
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 ">
      <div class="x_panel">
        <div class="x_title">
          <h2>รายการ ฝาก  ช่วงเวลา<small></small></h2>
          <div class="clearfix"></div>
        </div>
        <div class="row ">
          ...
          if (res.code == 1) {
            ...
            for(var i=0; i < conut; i++){
              var ctx = document.getElementById('myChart3');
                ...
                var sum_num = parseInt(wd[i]['num_dep01'])+parseInt(wd[i]['num_dep02'])+parseInt(wd[i]['num_dep03'])+parseInt(wd[i]['num_dep04'])
                        +parseInt(wd[i]['num_dep05'])+parseInt(wd[i]['num_dep06'])+parseInt(wd[i]['num_dep07'])+parseInt(wd[i]['num_dep08'])+
                        +parseInt(wd[i]['num_dep09'])+parseInt(wd[i]['num_dep10'])+parseInt(wd[i]['num_dep11'])+parseInt(wd[i]['num_dep12'])
                        +parseInt(wd[i]['num_dep13'])+parseInt(wd[i]['num_dep14'])+parseInt(wd[i]['num_dep15'])+parseInt(wd[i]['num_dep16'])
                        +parseInt(wd[i]['num_dep17'])+parseInt(wd[i]['num_dep18'])+parseInt(wd[i]['num_dep19'])+parseInt(wd[i]['num_dep20'])
                        +parseInt(wd[i]['num_dep21'])+parseInt(wd[i]['num_dep22'])+parseInt(wd[i]['num_dep23'])+parseInt(wd[i]['num_dep24']);
                        var sum1 	 =  
            ...
            var sum = '<tr><td colspan="1" class="text-right">รวม</td><td class="text-right">' +sum_num+
                        '</td><td class="text-right">' + sum1.toFixed(2)+'</td></tr>';
