...
<h2><a href="../../bank"><li class="fa fa-bank"></li></a> / <a href="#"><?=$bankWeb->account.' '.$bankWeb->name?></a></h2>
              <div class="col-md-12 col-sm-12 ">
                <div class="x_content">
                  <div class="row">
                    <div class="col-sm-12">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-5 col-sm-5 ">
                          ...
                          <div class="control-group">
                            <div class="controls">
                              <div class="col-md-11 xdisplay_inputx form-group row has-feedback">
                                <input type="text" class="form-control has-feedback-left" id="single_cal1" name="state_date" placeholder="First Name" aria-describedby="inputSuccess2Status">
				...
				<div class="col-md-4 col-sm-4 ">
					<input type="text" class="form-control" name="state_time" data-inputmask="'mask': '99:99'" value="<?=date('H:i')?>">
