               ...
               <div class="container" style="background-image: url(<?php echo $this->config->item('tem_frontend_img');?>imiwinbg.jpg);">
                        <ul class="product">
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content col-6">
                                 <p style="color: #fbff98;">SEXY BACCARAT</p>
                                 <p style="color: #fbff98;">ยุโรป <br> <span class="small_text">บาคาร่า | INSURANCE BACCARAT | เสือมังกร</span></p>
                                 <a class="play_button" onclick="alert('Login Now')" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imi999.com/data/1744/uploads/sb-casino.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content col-6">
                                 <p style="color: #fbff98;">LUCKY STREAK</p>
                                 <p style="color: #fbff98;">ยุโรป <br> <span class="small_text">บาคาร่า | รูเล็ต | แบล็คแจ็ค</span></p>
                                 <a class="play_button" onclick="alert('Login Now')" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imi999.com/data/1744/uploads/ls-banner.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content col-6">
                                 <p style="color: #fbff98;">WM CASINO</p>
                                 <p style="color: #fbff98;">กัมพูชา <br> <span class="small_text">บาคาร่า | เสือมังกร | รูเล็ต | ไฮโล | NIUNIU</span></p>
                                 <a class="play_button" onclick="alert('Login Now')" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imi999.com/data/1744/uploads/wm-casino.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content col-6">
                                 <p style="color: #fbff98;">GOLD DELUXE</p>
                                 <p style="color: #fbff98;">เอเชีย <br> <span class="small_text">บาคาร่า | รูเล็ต | ไฮโล</span></p>
                                 <a class="play_button" onclick="alert('Login Now')" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imi999.com/data/1744/uploads/gd-casino.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content col-6">
                                 <p style="color: #fbff98;">KING855</p>
                                 <p style="color: #fbff98;">กัมพูชา <br> <span class="small_text">บาคาร่า | คาสิโนโฮลด์เอ็ม | เสือมังกร | รูเล็ต | ไฮโล | การสู้วัวกระทิง</span></p>
                                 <a class="play_button" onclick="alert('Login Now')" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imi999.com/data/1744/uploads/ct855-casino.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content col-6">
                                 <p style="color: #fbff98;">ALLBET</p>
                                 <p style="color: #fbff98;">ฟิลิปปินส์ <br> <span class="small_text">บาคาร่า | รูเล็ต | เสือมังกร | ไฮโล</span></p>
                                 <a class="play_button" onclick="alert('Login Now')" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imi999.com/data/1744/uploads/ab-casino.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content col-6">
                                 <p style="color: #fbff98;">EVO CASINO</p>
                                 <p style="color: #fbff98;">ยุโรป <br> <span class="small_text">บาคาร่า | รูเล็ต | ไฮโล | เสือมังกร | TOP CARD | แบล็คแจ็ค | MONEY WHEEL</span></p>
                                 <a class="play_button" onclick="alert('Login Now')" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imi999.com/data/1744/uploads/evo-casino.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content col-6">
                                 <p style="color: #fbff98;">DREAM GAMING</p>
                                 <p style="color: #fbff98;">ยุโรป <br> <span class="small_text">บาคาร่า | เสือมังกร | รูเล็ต | ไฮโล | การสู้วัวกระทิง | ไตร</span></p>
                                 <a class="play_button" onclick="alert('Login Now')" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imi999.com/data/1744/uploads/dc-casino.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content col-6">
                                 <p style="color: #fbff98;">AG CASINO</p>
                                 <p style="color: #fbff98;">ฟิลิปปินส์ <br> <span class="small_text">บาคาร่า | รูเล็ต | ไฮโลมังกร | XOC-DIA | F.TEN</span></p>
                                 <a class="play_button" onclick="alert('Login Now')" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imi999.com/data/1744/uploads/ag-casino.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content col-6">
                                 <p style="color: #fbff98;">BIG GAMING</p>
                                 <p style="color: #fbff98;">เอเชีย <br> <span class="small_text">บาคาร่า | รูเล็ต | ไฮโล | เสือมังกร | วัวกระทิง | ไตร</span></p>
                                 <a class="play_button" onclick="alert('Login Now')" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imi999.com/data/1744/uploads/bg-casino.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content col-6">
                                 <p style="color: #fbff98;">FAIR GUARANTED GAMING</p>
                                 <p style="color: #fbff98;">เอเชีย <br> <span class="small_text">บาคาร่า | เสือมังกร | รูเล็ต | SHOOTDOOR | BULLBULL | ไตร | ไฮโล | วัวกระทิง | FANTAN | SEDIE</span></p>
                                 <a class="play_button" onclick="alert('Login Now')" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imi999.com/data/1744/uploads/fgg-casino.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content col-6">
                                 <p style="color: #fbff98;">SA GAMING</p>
                                 <p style="color: #fbff98;">เอเชีย <br> <span class="small_text">บาคาร่า | เสือมังกร | รูเล็ต | ไฮโล | FANTAN</span></p>
                                 <a class="play_button" onclick="alert('Login Now')" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imi999.com/data/1744/uploads/sa-casino.png">
                           </li>
                        </ul>
                     </div>  
                        ...
                        <center> 
                           <section class="flslider">
                              <div class="flexslider">
                                 <ul class="slides">
                                    <li class="flex-active-slide" style="width: 100%; float: left; margin-right: -100%; position: relative; opacity: 1; display: block; z-index: 2;"><a href="#"><img src="https://imiwin.com/data/1744/aimg/casino-banner-1.jpg" alt="" draggable="false"></a></li>
                                    <li class="" style="width: 100%; float: left; margin-right: -100%; position: relative; opacity: 0; display: block; z-index: 1;"><a href="#"><img src="https://imiwin.com/data/1744/aimg/casino-banner-2.jpg" alt="" draggable="false"></a></li>
                                 </ul>
          ...
          <div class="container" style="margin-top: 310px">
                        <ul class="product">
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content col-6">
                                 <p>SEXY BACCARAT</p>
                                 <p>ยุโรป <br> <span class="small_text">บาคาร่า | INSURANCE BACCARAT | เสือมังกร</span></p>
                                 <a class="play_button" onclick="alert('Login Now')" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imi999.com/data/1744/uploads/sb-casino.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content col-6">
                                 <p>LUCKY STREAK</p>
                                 <p>ยุโรป <br> <span class="small_text">บาคาร่า | รูเล็ต | แบล็คแจ็ค</span></p>
                                 <a class="play_button" onclick="alert('Login Now')" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imi999.com/data/1744/uploads/ls-banner.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content col-6">
                                 <p>WM CASINO</p>
                                 <p>กัมพูชา <br> <span class="small_text">บาคาร่า | เสือมังกร | รูเล็ต | ไฮโล | NIUNIU</span></p>
                                 <a class="play_button" onclick="alert('Login Now')" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imi999.com/data/1744/uploads/wm-casino.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content col-6">
                                 <p>GOLD DELUXE</p>
                                 <p>เอเชีย <br> <span class="small_text">บาคาร่า | รูเล็ต | ไฮโล</span></p>
                                 <a class="play_button" onclick="alert('Login Now')" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imi999.com/data/1744/uploads/gd-casino.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content col-6">
                                 <p>KING855</p>
                                 <p>กัมพูชา <br> <span class="small_text">บาคาร่า | คาสิโนโฮลด์เอ็ม | เสือมังกร | รูเล็ต | ไฮโล | การสู้วัวกระทิง</span></p>
                                 <a class="play_button" onclick="alert('Login Now')" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imi999.com/data/1744/uploads/ct855-casino.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content col-6">
                                 <p>ALLBET</p>
                                 <p>ฟิลิปปินส์ <br> <span class="small_text">บาคาร่า | รูเล็ต | เสือมังกร | ไฮโล</span></p>
                                 <a class="play_button" onclick="alert('Login Now')" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imi999.com/data/1744/uploads/ab-casino.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content col-6">
                                 <p>EVO CASINO</p>
                                 <p>ยุโรป <br> <span class="small_text">บาคาร่า | รูเล็ต | ไฮโล | เสือมังกร | TOP CARD | แบล็คแจ็ค | MONEY WHEEL</span></p>
                                 <a class="play_button" onclick="alert('Login Now')" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imi999.com/data/1744/uploads/evo-casino.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content col-6">
                                 <p>DREAM GAMING</p>
                                 <p>ยุโรป <br> <span class="small_text">บาคาร่า | เสือมังกร | รูเล็ต | ไฮโล | การสู้วัวกระทิง | ไตร</span></p>
                                 <a class="play_button" onclick="alert('Login Now')" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imi999.com/data/1744/uploads/dc-casino.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content col-6">
                                 <p>AG CASINO</p>
                                 <p>ฟิลิปปินส์ <br> <span class="small_text">บาคาร่า | รูเล็ต | ไฮโลมังกร | XOC-DIA | F.TEN</span></p>
                                 <a class="play_button" onclick="alert('Login Now')" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imi999.com/data/1744/uploads/ag-casino.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content col-6">
                                 <p>BIG GAMING</p>
                                 <p>เอเชีย <br> <span class="small_text">บาคาร่า | รูเล็ต | ไฮโล | เสือมังกร | วัวกระทิง | ไตร</span></p>
                                 <a class="play_button" onclick="alert('Login Now')" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imi999.com/data/1744/uploads/bg-casino.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content col-6">
                                 <p>FAIR GUARANTED GAMING</p>
                                 <p>เอเชีย <br> <span class="small_text">บาคาร่า | เสือมังกร | รูเล็ต | SHOOTDOOR | BULLBULL | ไตร | ไฮโล | วัวกระทิง | FANTAN | SEDIE</span></p>
                                 <a class="play_button" onclick="alert('Login Now')" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imi999.com/data/1744/uploads/fgg-casino.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content col-6">
                                 <p>SA GAMING</p>
                                 <p>เอเชีย <br> <span class="small_text">บาคาร่า | เสือมังกร | รูเล็ต | ไฮโล | FANTAN</span></p>
                                 <a class="play_button" onclick="alert('Login Now')" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imi999.com/data/1744/uploads/sa-casino.png">
                           </li>
