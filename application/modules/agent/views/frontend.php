         ...
         <div id="lazy-contain">
            <div class="dash-widgets css-loader-ready">
               ...
               <div class="row container--dashboard" style="background-image: url(<?php  echo $this->config->item('tem_frontend_img'); ?>casinoBG.jpg);">
                  ...
                  <div class="col-xs-4"><!-- href="line://ti/p/@imiwinshop" -->
                     <a href="#" >
...
<main class="main">
   <div class="slideshow-container">
      <div class="mySlides fade">
         ...
         <img src="<?php echo $this->config->item('tem_frontend_img'); ?>slide/agent.jpg" style="width:100%" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย">
      </div>
      <div class="mySlides fade">
         <div class="numbertext">2 / 5</div>
         <img src="<?php echo $this->config->item('tem_frontend_img'); ?>slide/football.jpg" style="width:100%" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย">
      </div>
      <div class="mySlides fade">
         <div class="numbertext">3 / 5</div>
         <img src="<?php echo $this->config->item('tem_frontend_img'); ?>slide/casino.jpg" style="width:100%" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย">
      </div>
      <div class="mySlides fade">
         <div class="numbertext">4 / 5</div>
         <img src="<?php echo $this->config->item('tem_frontend_img'); ?>slide/game.jpg" style="width:100%" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย">
      </div>
      <div class="mySlides fade">
         <div class="numbertext">5 / 5</div>
         <img src="<?php echo $this->config->item('tem_frontend_img'); ?>slide/lotto.jpg" style="width:100%" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย">
      </div>
   </div>
   ...
   <div class="partner-container" >
      <a id='partners-link' href="#" >
      <img class="lazy-loaded" src="<?php  echo $this->config->item('tem_frontend_img'); ?>btn/banner.png" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย">
      </a>
   </div>
         ...
         <div class="featured-list">
            <div class="featured-division col-4">
               <div class="featured-item">
                  ...
                  <p class="ambassador"><img class="lazy-loaded" src="<?php echo $this->config->item('tem_frontend_img'); ?>btn/imiwin.png" width="250" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย"></p>
                  <div class="featured-hover-wrapper">
                     <div class="featured-hover">                                  
                        <span class="hover-center">
                        <a class="btn btn-medium" href="<?php echo base_url()?>agent/web/win">ดูผลิตภัณฑ์</a>
                        </span>
                     </div>
                  </div>
               </div>
            ...
            <div class="featured-division stage-tile col-4">
               <div class="featured-item">
                  ...
                  <p class="ambassador"><img class="lazy-loaded" src="<?php echo $this->config->item('tem_frontend_img'); ?>btn/imiplus.png" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย"></p>
                  <div class="featured-hover-wrapper">
                     <div class="featured-hover">
                        <span class="hover-center">
            ...
            <div class="featured-division stage-tile col-4">
               <div class="featured-item">
                  ...
                  <p class="ambassador"><img class="lazy-loaded" src="<?php echo $this->config->item('tem_frontend_img'); ?>btn/api.png" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย"></p>
                  <div class="featured-hover-wrapper">
                     <div class="featured-hover">
                        <span class="hover-center">
            ...
            <div class="featured-division stage-tile col-4">
               <div class="featured-item">
                  ...
                  <p class="ambassador"><img class="lazy-loaded" src="<?php echo $this->config->item('tem_frontend_img'); ?>btn/lotto.png" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย"></p>
                  <div class="featured-hover-wrapper">
                     <div class="featured-hover">
                        <span class="hover-center">
                        <a id='tile-4' class="btn btn-medium" href="#popup2225" target="_top">ดูผลิตภัณฑ์</a>
                        </span>
                     </div>
                  </div>
               </div>
            ...
            <div class="featured-division stage-tile col-4">
               <div class="featured-item">
                  ...
                  <p class="ambassador"><img class="lazy-loaded" src="<?php echo $this->config->item('tem_frontend_img'); ?>btn/auto1.png" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย"></p>
                  <div class="featured-hover-wrapper">
                     <div class="featured-hover">
                        <span class="hover-center">
            ...
            <div class="featured-division stage-tile col-4">
               <div class="featured-item">
                  ...
                  <p class="ambassador"><img class="lazy-loaded" src="<?php echo $this->config->item('tem_frontend_img'); ?>btn/exx.png" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย"></p>
                  <div class="featured-hover-wrapper">
                     <div class="featured-hover">
                        <span class="hover-center">
                        <a id='tile-4' class="btn btn-medium" href="<?php echo base_url()?>agent/web/manual_marketing" target="_blank">ดูผลิตภัณฑ์</a>
                        </span>
                     </div>
                  </div>
               </div>
...
<div id="popup" class="overlay">
   <div class="popup" style="background-image: url(<?php  echo $this->config->item('tem_frontend_img'); ?>casinoBG.jpg);">
      ...
      <div class="content">
         <div class="grid">
            <div class="col-xs-12"> 
               <a href="<?php echo base_url()?>agent/web/apisport" > 
               <img src="<?php echo $this->config->item('tem_frontend_img'); ?>icon/sport.png" alt="เอเย่นต์ แทงบอล บาคาร่า" width="35"><span class="title_clubw">API SPORT</span> 
               </a> 
            </div>
            <div class="col-xs-12"> 
               <a href="<?php echo base_url()?>agent/web/apicasino"> 
               <img src="<?php echo $this->config->item('tem_frontend_img'); ?>icon/casino.png" alt="เอเย่นต์ แทงบอล บาคาร่า" width="35"><span class="title_clubw">API CASINO</span> 
               </a> 
            </div>
            <div class="col-xs-12"> 
               <a href="<?php echo base_url()?>agent/web/apigame"> 
               <img src="<?php echo $this->config->item('tem_frontend_img'); ?>icon/game.png" alt="เอเย่นต์ แทงบอล บาคาร่า" width="35"><span class="title_clubw">API GAMING</span> 
               </a> 
            </div>
            <div class="col-xs-12"> 
               <a href="<?php echo base_url()?>agent/web/apipackage"> 
               <img src="<?php echo $this->config->item('tem_frontend_img'); ?>icon/pack1.png" alt="เอเย่นต์ แทงบอล บาคาร่า" width="35"><span class="title_clubw">API PACKAGE</span> 
               </a> 
            </div>
         </div>
      </div>
...
<div id="popup2225" class="overlay">
   <div class="popup" style="background-image: url(<?php  echo $this->config->item('tem_frontend_img'); ?>casinoBG.jpg);" alt="พื้นหลัง imiwinshop เอเย่นต์ แทงบอล บาคาร่า">
      <h1 style="color: white;">  ผลิตภัณฑ์หวย</h1>
      <a class="close" href="#">&times;</a>
      <div class="content">
         <center> 
            <img src="<?php echo $this->config->item('tem_frontend_img'); ?>btn/lotto57.jpg" class="img-responsive" alt="เอเย่นต์ แทงบอล บาคาร่า" width="50%">
         </center>
         <br>      
         <div class="col-12">
            <center>
...
<div id="popup3" class="overlay">
   <div class="popup" style="background-image: url(<?php  echo $this->config->item('tem_frontend_img'); ?>casinoBG.jpg); margin-top: 150px" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย">
      ...
      <div class="content">
         <div class="col-12">
            ...
            <div class="featured-division col-6">
               <img class="lazy-loaded" src="<?php echo $this->config->item('tem_frontend_img'); ?>btn/11.jpg" width="100%" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย">
            </div>
         </div>
      </div>
   </div>
...
<div id="popup4" class="overlay">
   <div class="popup" style="background-image: url(<?php  echo $this->config->item('tem_frontend_img'); ?>casinoBG.jpg);">
      <h1 style="color: white;">  ผลิตภัณฑ์</h1>
      <a class="close" href="#">&times;</a>
      <div class="content">
         <div class="grid">
            >
            <section class="col-4 site-keyword">
               <ul>
                  <img src="<?php echo $this->config->item('tem_frontend_img'); ?>btn/betclic1.png" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย"><br>
                  <img src="<?php echo $this->config->item('tem_frontend_img'); ?>btn/isc8881.png" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย">
                  <img src="<?php echo $this->config->item('tem_frontend_img'); ?>btn/nova881.png" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย">
                  <img src="<?php echo $this->config->item('tem_frontend_img'); ?>btn/holiday1.png" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย">
                  <img src="<?php echo $this->config->item('tem_frontend_img'); ?>btn/918kiss1.png" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย">
               </ul>
            </section>
            <section class="col-4 text-center">
               <ul>
                  <img src="<?php echo $this->config->item('tem_frontend_img'); ?>btn/sbo1.png" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย">
                  <img src="<?php echo $this->config->item('tem_frontend_img'); ?>btn/siri3651.png" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย">
                  <img src="<?php echo $this->config->item('tem_frontend_img'); ?>btn/ufa1.png" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย">
                  <img src="<?php echo $this->config->item('tem_frontend_img'); ?>btn/m1681.png" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย">
                  <img src="<?php echo $this->config->item('tem_frontend_img'); ?>btn/joker.png" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย">
               </ul>
            </section>
            <section class="col-4 text-center">
               <ul>
                  <img src="<?php echo $this->config->item('tem_frontend_img'); ?>btn/928bet1.png" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย">
                  <img src="<?php echo $this->config->item('tem_frontend_img'); ?>btn/sa361.png" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย">
                  <img src="<?php echo $this->config->item('tem_frontend_img'); ?>btn/gclub1.png" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย">
                  <img src="<?php echo $this->config->item('tem_frontend_img'); ?>btn/sexylug.png" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย">
                  <img src="<?php echo $this->config->item('tem_frontend_img'); ?>btn/imigame88.png" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย">
               </ul>
            </section>
         </div>
      </div>
                  ...
                  <div class="featured-list">
                     <div class="featured-division col-6">
                        <div class="featured-item">
                           ...
                           <p class="ambassador"><img class="lazy-loaded" src="<?php echo $this->config->item('tem_frontend_img'); ?>icon/sport2.png" width="250" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย"></p>
                           <div class="featured-hover-wrapper">
                              <div class="featured-hover">                                  
                                 <span class="hover-center">
                                 <a class="btn btn-medium" href="<?php echo base_url()?>agent/web/apisport" target="_blank">ดูผลิตภัณฑ์</a>
                                 </span>
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="featured-list">
                     <div class="featured-division col-6">
                        <div class="featured-item">
                           ...
                           <p class="ambassador"><img class="lazy-loaded" src="<?php echo $this->config->item('tem_frontend_img'); ?>icon/casino2.png" width="250" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย"></p>
                           <div class="featured-hover-wrapper">
                              <div class="featured-hover">                                  
                                 <span class="hover-center">
                                 <a class="btn btn-medium" href="<?php echo base_url()?>agent/web/apicasino" target="_blank">ดูผลิตภัณฑ์</a>
                                 </span>
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="featured-list">
                     <div class="featured-division col-6">
                        <div class="featured-item">
                           ...
                           <p class="ambassador"><img class="lazy-loaded" src="<?php echo $this->config->item('tem_frontend_img'); ?>icon/game2.png" width="250" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย"></p>
                           <div class="featured-hover-wrapper">
                              <div class="featured-hover">                                  
                                 <span class="hover-center">
                                 <a class="btn btn-medium" href="<?php echo base_url()?>agent/web/apigame" target="_blank">ดูผลิตภัณฑ์</a>
                                 </span>
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="featured-list">
                     <div class="featured-division col-6">
                        <div class="featured-item">
                           ...
                           <p class="ambassador"><img class="lazy-loaded" src="<?php echo $this->config->item('tem_frontend_img'); ?>icon/pack2.png" width="250" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย"></p>
                           <div class="featured-hover-wrapper">
                              <div class="featured-hover">                                  
                                 <span class="hover-center">
                                 <a class="btn btn-medium" href="<?php echo base_url()?>agent/web/apipackage" target="_blank">ดูผลิตภัณฑ์</a>
                                 </span>
                              </div>
                           </div>
                        </div>
...
<div id="popup6" class="overlay">
   <div class="popup" style="background-image: url(<?php  echo $this->config->item('tem_frontend_img'); ?>casinoBG.jpg);" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย">
      ...
      <div class="content">
         <div class="grid">
            <section class="col-12">
               <ul>
                  <img src="<?php  echo $this->config->item('tem_frontend_img'); ?>auto.png" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย"><br>
               </ul>
            </section>
         </div>
      </div>
   ...
   <div class="popup" style="background-image: url(<?php  echo $this->config->item('tem_frontend_img'); ?>casinoBG.jpg);" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย">
      ...
      <div class="content">
         <div class="grid">
            <section class="col-6">
               <ul>
                  <img src="<?php  echo $this->config->item('tem_frontend_img'); ?>easy168.png" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย"><br>
               </ul>
            </section>
            <section class="col-6">
               <ul>
                  <img src="<?php  echo $this->config->item('tem_frontend_img'); ?>sport/siri365.png" alt="สมัครเอเย่นต์ แทงบอล คาสิโน หวย"><br>
               </ul>
            </section>
         </div>
      </div>
