                ...
                <ul class="product">
                  <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                    <div class="product_content">
                      <p style="color: #fbff98;">ไก่ชน</p>
                      <p style="color: #fbff98;">เกมไก่ชนบาคาร่า <br> <span class="small_text">ไก่ 1 ตัวที่ฆ่าเร็วที่สุด</span></p>
                        <a class="play_button" onclick="alert('Login Now')" href="">เล่นตอนนี้</a>
                    </div>
                     <img class="img100" src="https://imiwin.com/data/1744/uploads/img-cockfight-cockfight.png">
                  </li>
                </ul>
              </div>
                        ...
                        <center> 
                           <section class="flslider">
                              <div class="flexslider">
                                 <ul class="slides">
                                    <li class="flex-active-slide" style="width: 100%; float: left; margin-right: -100%; position: relative; opacity: 1; display: block; z-index: 2;"><a href="#"><img src="https://imiwin.com/data/1744/aimg/993x360-cockfight03.jpg" alt="" draggable="false"></a></li>
                                    <li class="" style="width: 100%; float: left; margin-right: -100%; position: relative; opacity: 0; display: block; z-index: 1;"><a href="#"><img src="https://imiwin.com/data/1744/aimg/993x360-cockfight02.jpg" alt="" draggable="false"></a></li>
                                 </ul>
      ...
      <div class="container" style="margin-top: 310px">
        <ul class="product">
          <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
            <div class="product_content">
              <p>ไก่ชน</p>
              <p>เกมไก่ชนบาคาร่า <br> <span class="small_text">ไก่ 1 ตัวที่ฆ่าเร็วที่สุด</span></p>
                <a class="play_button" onclick="alert('Login Now')" href="">เล่นตอนนี้</a>
            </div>
             <img class="img100" src="https://imiwin.com/data/1744/uploads/img-cockfight-cockfight.png">
          </li>
