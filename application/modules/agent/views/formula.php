...
<div class="canvas" canvas="container" id="canvas">
  <div class="main-screen">
    <header class="header"> <a href="<?php echo base_url()?>web/" class="header-button header-button-left" id="nav-btn"><span class="icon icon-navicon"></span></a>
      <h1 class="header-title"><a href="<?php echo base_url()?>web/"><img alt="เอเย่นต์ แทงบอล บาคาร่า" src="<?php  echo $this->config->item('tem_frontend_img'); ?>logo.png"></a></h1>
      </header>
    <section class="body" style="background-image: url(<?php  echo $this->config->item('tem_frontend_img'); ?>m/bg.jpg);">     
      <div id="lazy-contain">
            ...
            <div class="featured-list">
                <div class="featured-division col-4">
                  <div class="featured-item">
                    <p class="ambassador">                      
                      <img class="lazy-loaded" src="<?php echo $this->config->item('tem_frontend_img'); ?>m/1.png" style="width: 100%">                     
                    </p>
                  </div>
                </div>
                ...
                <div class="featured-division col-4">
                  <div class="featured-item">                  
                  <p class="ambassador">                   
                    <img class="lazy-loaded" src="<?php echo $this->config->item('tem_frontend_img'); ?>m/2.png" style="width: 100%">                  
                  </p>
                  </div>
                </div> 
                ...
                <div class="featured-division col-4">
                  <div class="featured-item">                  
                  <p class="ambassador">                   
                    <img class="lazy-loaded" src="<?php echo $this->config->item('tem_frontend_img'); ?>m/3.png"style="width: 100%">                  
                  </p>
                  </div>
                </div> 
                ...
                <div class="featured-division col-4">
                  <div class="featured-item">                  
                  <p class="ambassador">                   
                    <img class="lazy-loaded" src="<?php echo $this->config->item('tem_frontend_img'); ?>m/4.png"style="width: 100%">                  
                  </p>
                  </div>
                </div> 
                ...
                <div class="featured-division col-4">
                  <div class="featured-item">                  
                  <p class="ambassador">                   
                    <img class="lazy-loaded" src="<?php echo $this->config->item('tem_frontend_img'); ?>m/5.png"style="width: 100%">                  
                  </p>
                  </div>
                </div> 
                ...
                <div class="featured-division col-4">
                  <div class="featured-item">                  
                  <p class="ambassador">                   
                    <img class="lazy-loaded" src="<?php echo $this->config->item('tem_frontend_img'); ?>m/6.png"style="width: 100%">                  
                  </p>
                  </div>
                </div> 
                ...
                <div class="featured-division col-4">
                  <div class="featured-item">                  
                  <p class="ambassador">                   
                    <img class="lazy-loaded" src="<?php echo $this->config->item('tem_frontend_img'); ?>m/7.png"style="width: 100%">                  
                  </p>
                  </div>
                </div> 
                ...
                <div class="featured-division col-4">
                  <div class="featured-item">                  
                  <p class="ambassador">                   
                    <img class="lazy-loaded" src="<?php echo $this->config->item('tem_frontend_img'); ?>m/8.png"style="width: 100%">                  
                  </p>
                  </div>
                </div> 
                ...
                <div class="featured-division col-4">
                  <div class="featured-item">                  
                  <p class="ambassador">                   
                    <img class="lazy-loaded" src="<?php echo $this->config->item('tem_frontend_img'); ?>m/9.png"style="width: 100%">                  
                  </p>
                  </div>
                </div>
...
<div class="home-footer">
  <p id="copyright"><h2><img src="<?php  echo $this->config->item('tem_frontend_img'); ?>logo.png" alt="เอเย่นต์ แทงบอล บาคาร่า" class="img-responsive center-block" style="width: 80%;text-align: center;"></h2></p>
</div>
</section>
  </div>
 ...
 <!DOCTYPE html>
  <html>
    <head>
      ...
      <body >
      <section class="featured-procuts-section container" style="background-image: url(<?php  echo $this->config->item('tem_frontend_img'); ?>m/bg.jpg);">
          ...
          <div class="featured-product" style="margin-top: 80px">
            <div class="featured-list">
                <div class="featured-division col-4">
                  <div class="featured-item">
                    <p class="ambassador">                      
                      <img class="lazy-loaded" src="<?php echo $this->config->item('tem_frontend_img'); ?>m/1.png">                     
                    </p>
                  </div>
                </div>
                ...
                <div class="featured-division col-4">
                  <div class="featured-item">                  
                  <p class="ambassador">                   
                    <img class="lazy-loaded" src="<?php echo $this->config->item('tem_frontend_img'); ?>m/2.png" >                  
                  </p>
                  </div>
                </div> 
                ...
                <div class="featured-division col-4">
                  <div class="featured-item">                  
                  <p class="ambassador">                   
                    <img class="lazy-loaded" src="<?php echo $this->config->item('tem_frontend_img'); ?>m/3.png" >                  
                  </p>
                  </div>
                </div> 
                ...
                <div class="featured-division col-4">
                  <div class="featured-item">                  
                  <p class="ambassador">                   
                    <img class="lazy-loaded" src="<?php echo $this->config->item('tem_frontend_img'); ?>m/4.png" >                  
                  </p>
                  </div>
                </div> 
                ...
                <div class="featured-division col-4">
                  <div class="featured-item">                  
                  <p class="ambassador">                   
                    <img class="lazy-loaded" src="<?php echo $this->config->item('tem_frontend_img'); ?>m/5.png" >                  
                  </p>
                  </div>
                </div> 
                ...
                <div class="featured-division col-4">
                  <div class="featured-item">                  
                  <p class="ambassador">                   
                    <img class="lazy-loaded" src="<?php echo $this->config->item('tem_frontend_img'); ?>m/6.png" >                  
                  </p>
                  </div>
                </div> 
                ...
                <div class="featured-division col-4">
                  <div class="featured-item">                  
                  <p class="ambassador">                   
                    <img class="lazy-loaded" src="<?php echo $this->config->item('tem_frontend_img'); ?>m/7.png" >                  
                  </p>
                  </div>
                </div> 
                ...
                <div class="featured-division col-4">
                  <div class="featured-item">                  
                  <p class="ambassador">                   
                    <img class="lazy-loaded" src="<?php echo $this->config->item('tem_frontend_img'); ?>m/8.png" >                  
                  </p>
                  </div>
                </div> 
                ...
                <div class="featured-division col-4">
                  <div class="featured-item">                  
                  <p class="ambassador">                   
                    <img class="lazy-loaded" src="<?php echo $this->config->item('tem_frontend_img'); ?>m/9.png" >                  
                  </p>
                  </div><br>
                </div>
