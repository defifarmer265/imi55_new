                        ...
                        <ul class="product">
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content">
                                 <p style="color: #fbff98;">DREAM TEACH</p>
                                 <p style="color: #fbff98;">เกมสล็อตประสิทธิภาพสูง <br> <span class="small_text">สล็อต | แจ็คพอต</span></p>
                                 <a class="play_button" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imiwin.com/data/1744/uploads/img-egame-dt.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content">
                                 <p style="color: #fbff98;">PLAYTECH</p>
                                 <p style="color: #fbff98;">เกมสล็อตยอดนิยม <br> <span class="small_text">อีเกมที่ใครก็อยากเล่น</span></p>
                                 <a class="play_button" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imiwin.com/data/1744/uploads/img-egame-dpt.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content">
                                 <p style="color: #fbff98;">PRAGMATIC</p>
                                 <p style="color: #fbff98;">150 เกมแรง <br> <span class="small_text">สล็อต | โต๊ะเกม | วิดีโอ</span></p>
                                 <a class="play_button" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imiwin.com/data/1744/uploads/img-egame-pragmatic.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content">
                                 <p style="color: #fbff98;">BETSOFT</p>
                                 <p style="color: #fbff98;">เกมที่ได้รับความนิยมมากกว่า 150 เกม <br> <span class="small_text">3D, เกมในโรงภาพยนตร์ของจริง</span></p>
                                 <a class="play_button" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imiwin.com/data/1744/uploads/img-egame-betsoft.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content">
                                 <p style="color: #fbff98;">CQ9</p>
                              ...
                              <img class="img100" src="https://imiwin.com/data/1744/uploads/img-egame-cq9.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content">
                                 <p style="color: #fbff98;">VIRTUAL TECH</p>
                                 <p style="color: #fbff98;">เกมที่ได้รับความนิยม <br> <span class="small_text">สล็อต | แจ็คพอต</span></p>
                                 <a class="play_button" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imiwin.com/data/1744/uploads/img-egame-vt.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content">
                                 <p style="color: #fbff98;">SKYWIND</p>
                                 <p style="color: #fbff98;">เกมที่ได้รับความนิยม <br> <span class="small_text">สล็อต | แจ็คพอต</span></p>
                                 <a class="play_button" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imiwin.com/data/1744/uploads/img-egame-leocity88.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content">
                                 <p style="color: #fbff98;">GG </p>
                                 <p style="color: #fbff98;">เกมระดับโลก <br> <span class="small_text">การ์ดและเครื่องเล่น</span></p>
                                 <a class="play_button" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imiwin.com/data/1744/uploads/img-egame-gg.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content">
                                 <p style="color: #fbff98;">ACE GAME</p>
                                 <p style="color: #fbff98;">เกมที่ได้รับความนิยม <br> <span class="small_text">สล็อต | โต๊ะเกม | เกมอาเขต</span></p>
                                 <a class="play_button" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imiwin.com/data/1744/uploads/img-egame-ace333.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content">
                                 <p style="color: #fbff98;">JOKER</p>
                                 <p style="color: #fbff98;">ธีมที่หลากหลาย <br> <span class="small_text">อีเกมที่ใครก็อยากเล่น</span></p>
                                 <a class="play_button" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imiwin.com/data/1744/uploads/img-egame-joker.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content">
                                 <p style="color: #fbff98;">SA EGAMES</p>
                                 <p style="color: #fbff98;">ALL NEW SLOT GAMES <br> <span class="small_text">มินิสล็อตเกม</span></p>
                                 <a class="play_button" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imiwin.com/data/1744/uploads/img-egame-sae.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content">
                                 <p style="color: #fbff98;">BIG GAMING</p>
                                 <p style="color: #fbff98;">เกมที่ได้รับความนิยม <br> <span class="small_text">ปลา</span></p>
                                 <a class="play_button" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imiwin.com/data/1744/uploads/img-egame-bge.png">
                           </li>
                        </ul>
                     </div> 
                        ...
                        <center> 
                           <section class="flslider">
                              <div class="flexslider">
                                 <ul class="slides">
                                    <li class="flex-active-slide" style="width: 100%; float: left; margin-right: -100%; position: relative; opacity: 1; display: block; z-index: 2;"><a href="#"><img src="https://imiwin.com/data/1744/aimg/egame-banner-1.jpg" alt="" draggable="false"></a></li>
                                    <li class="" style="width: 100%; float: left; margin-right: -100%; position: relative; opacity: 0; display: block; z-index: 1;"><a href="#"><img src="https://imiwin.com/data/1744/aimg/egame-banner-2.jpg" alt="" draggable="false"></a></li>
                                 </ul>
                    ...
                    <div class="container" style="margin-top: 310px">
                        <ul class="product">
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content">
                                 <p>DREAM TEACH</p>
                                 <p>เกมสล็อตประสิทธิภาพสูง <br> <span class="small_text">สล็อต | แจ็คพอต</span></p>
                                 <a class="play_button" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imiwin.com/data/1744/uploads/img-egame-dt.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content">
                                 <p>PLAYTECH</p>
                                 <p>เกมสล็อตยอดนิยม <br> <span class="small_text">อีเกมที่ใครก็อยากเล่น</span></p>
                                 <a class="play_button" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imiwin.com/data/1744/uploads/img-egame-dpt.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content">
                                 <p>PRAGMATIC</p>
                                 <p>150 เกมแรง <br> <span class="small_text">สล็อต | โต๊ะเกม | วิดีโอ</span></p>
                                 <a class="play_button" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imiwin.com/data/1744/uploads/img-egame-pragmatic.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content">
                                 <p>BETSOFT</p>
                                 <p>เกมที่ได้รับความนิยมมากกว่า 150 เกม <br> <span class="small_text">3D, เกมในโรงภาพยนตร์ของจริง</span></p>
                                 <a class="play_button" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imiwin.com/data/1744/uploads/img-egame-betsoft.png">
                           </li>
                           ...
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content">
                                 <p>VIRTUAL TECH</p>
                                 <p>เกมที่ได้รับความนิยม <br> <span class="small_text">สล็อต | แจ็คพอต</span></p>
                                 <a class="play_button" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imiwin.com/data/1744/uploads/img-egame-vt.png">
                           </li>
                           ...
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content">
                                 <p>GG </p>
                                 <p>เกมระดับโลก <br> <span class="small_text">การ์ดและเครื่องเล่น</span></p>
                                 <a class="play_button" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imiwin.com/data/1744/uploads/img-egame-gg.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content">
                                 <p>ACE GAME</p>
                                 <p>เกมที่ได้รับความนิยม <br> <span class="small_text">สล็อต | โต๊ะเกม | เกมอาเขต</span></p>
                                 <a class="play_button" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imiwin.com/data/1744/uploads/img-egame-ace333.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content">
                                 <p>JOKER</p>
                                 <p>ธีมที่หลากหลาย <br> <span class="small_text">อีเกมที่ใครก็อยากเล่น</span></p>
                                 <a class="play_button" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imiwin.com/data/1744/uploads/img-egame-joker.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content">
                                 <p>SA EGAMES</p>
                                 <p>ALL NEW SLOT GAMES <br> <span class="small_text">มินิสล็อตเกม</span></p>
                                 <a class="play_button" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imiwin.com/data/1744/uploads/img-egame-sae.png">
                           </li>
                           <li style="background-image: url(https://imi999.com/data/1742/uploads/bg-slot.png);background-repeat: no-repeat; background-size: 100% 100%;">
                              <div class="product_content">
                                 <p>BIG GAMING</p>
                                 <p>เกมที่ได้รับความนิยม <br> <span class="small_text">ปลา</span></p>
                                 <a class="play_button" href="">เล่นตอนนี้</a>
                              </div>
                              <img class="img100" src="https://imiwin.com/data/1744/uploads/img-egame-bge.png">
                           </li>
