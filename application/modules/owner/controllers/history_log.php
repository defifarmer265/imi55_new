...
<div class="row">
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
                                ...
                                <div class="col-md-12 xdisplay_inputx form-group row has-feedback">
                                    <select class=" form-control" id="slectop">
                                        ...
                                        <optgroup label="หมวด Admin" style="font-size:13px;">
                                            ...
                                            <option value="logcredit"> Log credit</option>
                                            ...
                                            <option value="loggift"> Log_imimall </option>
                                            ...
                                            <option value="Log_round_delete">Log_round_delete </option>

                                            <option value="Log_round_edit"> Log_round_edit </option>
            ...
            <p class="logcredit box text-danger " style="font-size:16px;"> ประวัติการเพิ่ม ลบ เครดิต </p>
            ...
            <p class="logbankstatus box text-danger " style="font-size:16px;"> ประวัติการการแก้ไข สถานะ แบงค์  </p>
            <p class="logeditgroup box text-danger " style="font-size:16px;"> ประวัติการการแก้ไข กลุ่ม แบงค์  </p>
            <p class="logeditusergroup box text-danger " style="font-size:16px;"> ประวัติการการแก้ไข กลุ่ม แบงค์ ของสมาชิก </p>
            <p class="logsale box text-danger " style="font-size:16px;"> ประวัติการการเข้าสู่ระบบ ของ เซลล์ </p>

            <p class="logusers box text-danger " style="font-size:16px;"> ประวัติการการเข้าสู่ระบบ ของ สมาชิก </p>
            <p class="logcheckin box text-danger " style="font-size:16px;"> ประวัติการการเช็คอิน ของ สมาชิก </p>
            ...
            <p class="logowner box text-danger " style="font-size:16px;"> ประวัติการการเข้าสู่ระบบ ของ Owner </p>
                                ...
                                <table id="emp_table" class="table table-striped table-bordered dt-responsive nowrap"
                                    ...
                                    <thead style="background-color: #2a3f54;color: #fff;">
                                        <tr class="text-center">
                                            ...
                                            <th class="  logcheckin box"> จำนวนการเช็คอิน</th>
                                            <th class="logcredit logedituserspin box"> ประเภท </th>
                                            <th class="logcredit logedituserspin logcheckin box"> รายละเอียด</th>
                                            ...
                                            <!-- logeditusername  logedituserpass  loguserstatus  logeidttel-->
                                            <th class=" box">
                                                No </th>
