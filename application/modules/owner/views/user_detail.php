                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <div class="form-group row">
                            <div class="col-sm-10"> ID : <?= $this->getapi_model->agent(); ?> ใส่แค่ตัวเลข 6 หลักหลัง
                                Ex: 7805
...
<!--
                        <div class="form-group row">
                            <div class="col-sm-10"> Account : ใส่เลขบัญชีลูกค้า
                                <input type="text" value="" class="form-control" id="t_account" placeholder="ชื่อลูกค้า">
                            </div>
                            <div class="col-sm-2"><br>
...
<!--
                        <div class="form-group row">
                            <div class="col-sm-10"> Name : ใส่ชื่อลูกค้า
                                <input type="text" value="" class="form-control" id="t_name" placeholder="ชื่อลูกค้า">
                            </div>
                            <div class="col-sm-2"><br>
                    ...
                    <div class="x_content">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 ">
                                ...
                                <div class="col-md-3 ">
                                    <button class="btn btn-outline-info" data-toggle="modal" data-target="#m_salename" onClick="salename()">
...
<!--
                    <div class="form-group row">
                        ...
                        <div class="col-md-9 ">
                            <input type="text" class="form-control has-feedback text-center" readonly value="" id="stakeMoney">
...
-->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9 ">
                            <input type="text" class="form-control has-feedback text-center" readonly value="" id="credit">
                                ...
                                <span style="cursor: pointer;" class="fa fa-arrow-down form-control-feedback left text-danger" aria-hidden="true" onClick="down_money()"></span>
                                <span style="cursor: pointer;" class="fa fa-arrow-up form-control-feedback right text-success" aria-hidden="true" onClick="up_money()"></span>
                    ...
                    <div class="form-group row">
                        <div class="col-md-12 form-group has-feedback">
                            ...
                            <button id="status1" style="display: none;" onClick="closeuser('2')" class="btn btn-outline-success">
                                <i class="fa fa-check"> เปิด</i>
                            </button>
                            <button id="status2" style="display: none;" onClick="closeuser('1')" class="btn btn-outline-danger">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 form-group ">
                                    <input type="text" class="form-control has-feedback text-center" readonly value="" id="point">
                                        ...
                                        <span style="cursor: pointer;" class="fa fa-arrow-down form-control-feedback left text-danger" aria-hidden="true" onClick="down_point()"></span>
                                        <span style="cursor: pointer;" class="fa fa-arrow-up form-control-feedback right text-success" aria-hidden="true" onClick="up_point()"></span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 form-group ">
                                    <input type="text" class="form-control has-feedback text-center" readonly value="" id="spin">
                                        ...
                                        <span style="cursor: pointer;" class="fa fa-arrow-down form-control-feedback left text-danger" aria-hidden="true" onClick="down_spin()"></span>
                                        <span style="cursor: pointer;" class="fa fa-arrow-up form-control-feedback right text-success" aria-hidden="true" onClick="up_spin()"></span>
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 form-group">
                                    <input type="text" class="form-control has-feedback text-center" readonly id="turnover">
                                    <span class="form-control-feedback left " aria-hidden="true">turn</span>
                                </div>
                                <div class="col-md-3 ">
                                    <button class="btn btn-outline-info" onClick="reset_turn()">
                                        <i class="fa fa-minus"> ตัดเทิร์น</i>
                                    </button>
                                </div>
                            </div>
                        </div>
                        <div class="x_content">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 form-group ">
                                    <input type="text" class="form-control has-feedback text-center" id="date_turn" readonly>
                ...
                <div class="col-md-12 col-sm-12  form-group has-feedback">
                    <div class="form-group row">
                        ...
                        <div class="col-md-9 col-sm-9 ">
                            <input type="number" class="form-control" id="edit_account" name="account" maxlength="12" autocomplete="off">
                        </div>
                    </div>
                </div>
                <div class="col-md-12 col-sm-12  form-group has-feedback">
...
<div class="modal fade" id="m_editUser" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-md-12 col-sm-12  form-group has-feedback">
                    <input type="text" class="form-control has-feedback-left" id="edit_name" placeholder="ชื่อ - สกุล" required="required" name="name" autocomplete="off">
                    <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                </div>
            </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="col-md-12 col-sm-12  form-group has-feedback">
                    <input type="text" class="form-control has-feedback-left" id="ie_username" placeholder="รหัสลูกค้า / เบอร์โทร" required="required" name="ie_username" autocomplete="off">
                    <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                </div>
        ...
        $.ajax({
            ...
            .done(function(res) {
                ...
                if (res.code == 1) {
                    ...
                    var img_bnk = '<?= $this->config->item('tem_frontend') ?>img/mapraw_icon/bank/' + res.data.api_id +
                        '.png';
                    ...
                    for (var j = 0; j < conut2; j++) {
                        content2 += '<tr><td>' + j + '</td><td>' + add_cd[j]['CreationTime'] + '</td><td>' + add_cd[j][
                            'Amount'
                        ] + '</td></tr>';
            ...
            if (res.code == 1) {
                ...
                if (count > 0) {
                    for (var i = 0; i < count; i++) {
                        content += '<option value="' + sale[i]['id'] + '" id="salename">' + sale[i]['name'] +
                            '</option>'
                    }
                }
