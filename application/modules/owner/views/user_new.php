            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="card-box table-responsive">
                  ...
                  <table id="user1" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    ...
                    <tbody>
                      ...
                      foreach ($user as $_u => $us) { ?>
                        <tr align="center">
                          ...
                          <td><a href="#" class="btn btn-secondary btn-sm" onClick="see_credit('<?= $us['id'] ?>')" title="ดูเครดิต">C</a></td>
      ...
      <form class="form-label-left input_mask" id="form_cre_user">
        <div class="modal-body">
          <div class="col-md-6 col-sm-6  form-group has-feedback" id="div_username">
            <input type="text" class="form-control has-feedback-left" id="user" placeholder="เบอร์โทร" required="required" name="username" autocomplete="off">
          ...
          <div class="col-md-6 col-sm-6  form-group has-feedback" id="div_pass">
            <input type="text" class="form-control" id="password" placeholder="Password" required="required" name="password" onChange="ckpass()" autocomplete="off" value="">
          ...
          <div class="col-md-12 col-sm-12  form-group has-feedback">
            <div class="form-group row">
              ...
              <div class="col-md-9 col-sm-9 ">
                <input type="number" class="form-control" id="account" name="account" placeholder="" maxlength="12" autocomplete="off">
              </div>
            </div>
          </div>
        </div>
