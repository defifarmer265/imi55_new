                ...
                <div class="x_content">
                    <div class="row">
                        <div class="col-sm-12">
							...
							?>
                                                <a href="#"
                                                    onClick="edit_limit('<?=$bnk['id']?>','<?=$bnk['limit_amount']?>')"><i
                        ...
                        ?></td>
                                            ...
                                            <td>
                                                ...
                                                <a href="#"
                                                    onClick="edit_statusBank('<?=$bnk['id']?>','<?=$bnk['bank_web_id']?>','0')"
                                                    title="ปิด">
                                                    <i style="color:#3AED33;" class="fa fa-check"></i>
                                                </a>
                                                <?php }else if($bnk[ 'status' ] == 0){?>
                                                <a href="#"
                                                    onClick="edit_statusBank('<?=$bnk['id']?>','<?=$bnk['bank_web_id']?>','1')"
                                                    title="เปิด">
                                            ...
                                            <td>
                                                <a href="#"
                                                    onClick="edit_statusBank('<?=$bnk['id']?>','<?=$bnk['bank_web_id']?>','4')"
                                                    title="เปิด">
                                                    <i style="color:#F51F23;" class="fa fa-remove"></i>
                                                </a>
                                            </td>
