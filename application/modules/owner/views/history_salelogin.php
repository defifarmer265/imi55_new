                ...
                <div class="col-md-12 col-sm-12 ">
                    ...
                    <div class="x_content">
                        ...
                        <div class="row ">
                            ...
                            <div class="col-sm-2">
                                <br>
                                <button onClick="search_sale()" class="btn btn-info">ค้นหา</button>
                            </div>
                        </div>
                                    ...
                                    <table id="table_salelog" class="table table-striped table-bordered dt-responsive nowrap text-center" cellspacing="0" width="100%" id="t_all">
                                        ...
                                        <tbody  id="bodyhistory">
                                            ...
                                            <tr>
                                                ...
                                                <td><?=$s['type']?></td>
                                                <td><?=$s['detail']?></td>
                                                <td><?=date('d/m/Y H:i:s',$s['datetime'])?></td>
                                            </tr>
                                            <?php $i++; }?>
                                        </tbody>
