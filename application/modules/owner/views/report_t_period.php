        ...
        <div class="modal-content">
            ...
            <div class="modal-header btn-success">
                <h5 class="modal-title" id="list"><i class="fa fa-bar-chart" aria-hidden="true"></i>
                    กราฟรายการฝาก-จำนวนเงินฝาก ช่วงเวลา</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
...
function select_period() {
    ...
    //  console.log(tm2);
    $.ajax({
            url: '<?=base_url()?>owner/report_time_period/time_pd',
            type: 'POST',
            dataType: 'json',
            data: {
                dt1: dt1,
                ...
                if (res.data.length >= 1) {
                    ...
                    for (var i = 0; i < conut; i++) {
                        ...
                        content += '<td class="text-right">' +
                            ...
                            nb(wd[i].num_dep01) + '</a>' + ' </td>';
                        content += '<td class="text-right text-success">' + nb(wd[i].sum_dep01.toFixed(2)) +
                            '</td>';
                        ...
                        content += '<td class="text-right">' +
                            ...
                            nb(wd[i].num_dep02) + '</a>' + ' </td>';
                        content += '<td class="text-right text-success">' + nb(wd[i].sum_dep02.toFixed(2)) +
                            '</td>';
                        content += '</tr>';
                        content += '<tr>';
                        ...
                        content += '<td class="text-right">' +
                            ...
                            nb(wd[i].num_dep03) + '</a>' + ' </td>';
                        content += '<td class="text-right text-success">' + nb(wd[i].sum_dep03.toFixed(2)) +
                            '</td>';
                        content += '</tr>';
                        content += '<tr>';
                        ...
                        content += '<td class="text-right">' +
                            ...
                            nb(wd[i].num_dep04) + '</a>' + ' </td>';
                        content += '<td class="text-right text-success">' + nb(wd[i].sum_dep04.toFixed(2)) +
                            '</td>';
                        content += '</tr>';
                        content += '<tr>';
                        ...
                        content += '<td class="text-right">' +
                            ...
                            nb(wd[i].num_dep05) + '</a>' + ' </td>';
                        content += '<td class="text-right text-success">' + nb(wd[i].sum_dep05.toFixed(2)) +
                            '</td>';
                        content += '</tr>';
                        content += '<tr>';
                        ...
                        content += '<td class="text-right">' +
                            ...
                            nb(wd[i].num_dep06) + '</a>' + ' </td>';
                        content += '<td class="text-right text-success">' + nb(wd[i].sum_dep06.toFixed(2)) +
                            '</td>';
                        content += '</tr>';
                        content += '<tr>';
                        ...
                        content += '<td class="text-right">' +
                            ...
                            nb(wd[i].num_dep07) + '</a>' + ' </td>';
                        content += '<td class="text-right text-success">' + nb(wd[i].sum_dep07.toFixed(2)) +
                            '</td>';
                        content += '</tr>';
                        content += '<tr>';
                        ...
                        content += '<td class="text-right">' +
                            ...
                            nb(wd[i].num_dep08) + '</a>' + ' </td>';
                        content += '<td class="text-right text-success">' + nb(wd[i].sum_dep08.toFixed(2)) +
                            '</td>';
                        content += '</tr>';
                        content += '<tr>';
                        ...
                        content += '<td class="text-right">' +
                            ...
                            nb(wd[i].num_dep09) + '</a>' + ' </td>';
                        content += '<td class="text-right text-success">' + nb(wd[i].sum_dep09.toFixed(2)) +
                            '</td>';
                        content += '</tr>';
                        content += '<tr>';
                        ...
                        content += '<td class="text-right">' +
                            ...
                            nb(wd[i].num_dep10) + '</a>' + ' </td>';
                        content += '<td class="text-right text-success">' + nb(wd[i].sum_dep10.toFixed(2)) +
                            '</td>';
                        content += '</tr>';
                        content += '<tr>';
                        ...
                        content += '<td class="text-right">' +
                            ...
                            nb(wd[i].num_dep11) + '</a>' + ' </td>';
                        content += '<td class="text-right text-success">' + nb(wd[i].sum_dep11.toFixed(2)) +
                            '</td>';
                        content += '</tr>';
                        content += '<tr>';
                        ...
                        content += '<td class="text-right">' +
                            ...
                            nb(wd[i].num_dep12) + '</a>' + ' </td>';
                        content += '<td class="text-right text-success">' + nb(wd[i].sum_dep12.toFixed(2)) +
                            '</td>';
                        content += '</tr>';
                        content += '<tr>';
                        ...
                        content += '<td class="text-right">' +
                            ...
                            nb(wd[i].num_dep13) + '</a>' + ' </td>';
                        content += '<td class="text-right text-success">' + nb(wd[i].sum_dep13.toFixed(2)) +
                            '</td>';
                        content += '</tr>';
                        content += '<tr>';
                        ...
                        content += '<td class="text-right">' +
                            ...
                            nb(wd[i].num_dep14) + '</a>' + ' </td>';
                        content += '<td class="text-right text-success">' + nb(wd[i].sum_dep14.toFixed(2)) +
                            '</td>';
                        content += '</tr>';
                        content += '<tr>';
                        ...
                        content += '<td class="text-right">' +
                            ...
                            nb(wd[i].num_dep15) + '</a>' + ' </td>';
                        content += '<td class="text-right text-success">' + nb(wd[i].sum_dep15.toFixed(2)) +
                            '</td>';
                        content += '</tr>';
                        content += '<tr>';
                        ...
                        content += '<td class="text-right">' +
                            ...
                            nb(wd[i].num_dep16) + '</a>' + ' </td>';
                        content += '<td class="text-right text-success">' + nb(wd[i].sum_dep16.toFixed(2)) +
                            '</td>';
                        content += '</tr>';
                        content += '<tr>';
                        ...
                        content += '<td class="text-right">' +
                            ...
                            nb(wd[i].num_dep17) + '</a>' + ' </td>';
                        content += '<td class="text-right text-success">' + nb(wd[i].sum_dep17.toFixed(2)) +
                            '</td>';
                        content += '</tr>';
                        content += '<tr>';
                        ...
                        content += '<td class="text-right">' +
                            ...
                            nb(wd[i].num_dep18) + '</a>' + ' </td>';
                        content += '<td class="text-right text-success">' + nb(wd[i].sum_dep18.toFixed(2)) +
                            '</td>';
                        content += '</tr>';
                        content += '<tr>';
                        ...
                        content += '<td class="text-right">' +
                            ...
                            nb(wd[i].num_dep19) + '</a>' + ' </td>';
                        content += '<td class="text-right text-success">' + nb(wd[i].sum_dep19.toFixed(2)) +
                            '</td>';
                        content += '</tr>';
                        content += '<tr>';
                        ...
                        content += '<td class="text-right">' +
                            ...
                            nb(wd[i].num_dep20) + '</a>' + ' </td>';
                        content += '<td class="text-right text-success">' + nb(wd[i].sum_dep20.toFixed(2)) +
                            '</td>';
                        content += '</tr>';
                        content += '<tr>';
                        ...
                        content += '<td class="text-right">' +
                            ...
                            nb(wd[i].num_dep21) + '</a>' + ' </td>';
                        content += '<td class="text-right text-success">' + nb(wd[i].sum_dep21.toFixed(2)) +
                            '</td>';
                        content += '</tr>';
                        content += '<tr>';
                        ...
                        content += '<td class="text-right">' +
                            ...
                            nb(wd[i].num_dep22) + '</a>' + ' </td>';
                        content += '<td class="text-right text-success">' + nb(wd[i].sum_dep22.toFixed(2)) +
                            '</td>';
                        content += '</tr>';
                        content += '<tr>';
                        ...
                        content += '<td class="text-right">' +
                            ...
                            nb(wd[i].num_dep23) + '</a>' + ' </td>';

                        content += '<td class="text-right text-success">' + nb(wd[i].sum_dep23.toFixed(2)) +
                            '</td>';
                        content += '</tr>';
                        content += '<tr>';
                        ...
                        content += '<td class="text-right">' +
                            ...
                            nb(wd[i].num_dep24) + '</a>' + ' </td>';
                        content += '<td class="text-right text-success">' + nb(wd[i].sum_dep24.toFixed(2)) +
                            '</td>';
                        content += '</tr>';
                        // รายการฝาก
                        var sum_num = parseInt(wd[i]['num_dep01']) + parseInt(wd[i]['num_dep02']) + parseInt(wd[i][
                                'num_dep03'
                            ]) + parseInt(wd[i]['num_dep04']) +
                            parseInt(wd[i]['num_dep05']) + parseInt(wd[i]['num_dep06']) + parseInt(wd[i][
                                'num_dep07'
                            ]) + parseInt(wd[i]['num_dep08']) +
                            +parseInt(wd[i]['num_dep09']) + parseInt(wd[i]['num_dep10']) + parseInt(wd[i][
                                'num_dep11'
                            ]) + parseInt(wd[i]['num_dep12']) +
                            parseInt(wd[i]['num_dep13']) + parseInt(wd[i]['num_dep14']) + parseInt(wd[i][
                                'num_dep15'
                            ]) + parseInt(wd[i]['num_dep16']) +
                            parseInt(wd[i]['num_dep17']) + parseInt(wd[i]['num_dep18']) + parseInt(wd[i][
                                'num_dep19'
                            ]) + parseInt(wd[i]['num_dep20']) +
                            parseInt(wd[i]['num_dep21']) + parseInt(wd[i]['num_dep22']) + parseInt(wd[i][
                                'num_dep23'
                            ]) + parseInt(wd[i]['num_dep24']);

                        //รวมจำนวนเงินฝาก
                        var sum1 =
                            (parseFloat(wd[i].sum_dep01.toFixed(2))) +
                            (parseFloat(wd[i].sum_dep02.toFixed(2))) +
                            (parseFloat(wd[i].sum_dep03.toFixed(2))) +
                            (parseFloat(wd[i].sum_dep04.toFixed(2))) +
                            (parseFloat(wd[i].sum_dep05.toFixed(2))) +
                            (parseFloat(wd[i].sum_dep06.toFixed(2))) +
                            (parseFloat(wd[i].sum_dep07.toFixed(2))) +
                            (parseFloat(wd[i].sum_dep08.toFixed(2))) +
                            (parseFloat(wd[i].sum_dep09.toFixed(2))) +
                            (parseFloat(wd[i].sum_dep10.toFixed(2))) +
                            (parseFloat(wd[i].sum_dep11.toFixed(2))) +
                            (parseFloat(wd[i].sum_dep12.toFixed(2))) +
                            (parseFloat(wd[i].sum_dep13.toFixed(2))) +
                            (parseFloat(wd[i].sum_dep14.toFixed(2))) +
                            (parseFloat(wd[i].sum_dep15.toFixed(2))) +
                            (parseFloat(wd[i].sum_dep16.toFixed(2))) +
                            (parseFloat(wd[i].sum_dep17.toFixed(2))) +
                            (parseFloat(wd[i].sum_dep18.toFixed(2))) +
                            (parseFloat(wd[i].sum_dep19.toFixed(2))) +
                            (parseFloat(wd[i].sum_dep20.toFixed(2))) +
                            (parseFloat(wd[i].sum_dep21.toFixed(2))) +
                            (parseFloat(wd[i].sum_dep22.toFixed(2))) +
                            (parseFloat(wd[i].sum_dep23.toFixed(2))) +
                            (parseFloat(wd[i].sum_dep24.toFixed(2)));
                        console.log(sum1);
                        // parseInt(wd[i]['sum_dep10'].toFixed(2))+ parseInt(wd[i]['sum_dep11'].toFixed(2))+parseInt(wd[i]['sum_dep14'].toFixed(2));
...
function select_deptest(d) {
    ...
    // //  console.log(dt2);
    $.ajax({
            url: '<?=base_url()?>owner/report_time_period/list_pdtest',
            type: 'POST',
            dataType: 'json',
            data: {
                dt1: dt1,
