                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <?=$bnk['bank_short'].'-'.substr($bnk['bank_th'],18,40)?></td>
                        ...
                        ?></td>
							  ...
							  ?>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="#" onClick="edit_statusBank('<?=$bnk['id']?>','0')"
                                                    title="ปิด">
                                                ...
                                                <?php }else{ ?>
                                                <a href="#" onClick="edit_statusBank('<?=$bnk['id']?>','1')"
                                                    title="เปิด">
                                            ...
                                            <td style="text-align:center;">
                                                <?php if ( $bnk[ 'status' ] != 3 ) { ?>
                                                <a href="#" onClick="edit_bank('<?=$bnk['id']?>')" title="แก้ไข"> <i
